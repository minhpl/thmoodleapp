...
//     CoreCoursesHelper,
//     CoreEnrolledCourseDataWithExtraInfo,
...
// })
// export class AddonBlockActivateCoursesComponent extends CoreBlockBaseComponent implements OnInit, OnDestroy {
...
//     constructor() {
//         super('AddonBlockActivateCoursesComponent');
...
//         const scrollId = CoreUtils.getUniqueId('AddonBlockActivateCoursesComponent-Scroll');
...
//         return site.read<AddonBlockRecentlyAccessedCourse[]>('block_th_activatecourses_get_users_courses3', data, preSets).then((courses) => {
//             const promises = [];
//             promises.push();
//             // this.courses = courses;
//             CoreCoursesHelper.loadCoursesExtraInfo(<CoreEnrolledCourseDataWithExtraInfo[]>courses, true).then(()=>{
//                 this.courses = courses;
