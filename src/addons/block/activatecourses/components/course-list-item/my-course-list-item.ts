...
import { CoreCoursesCourseOptionsMenuComponent } from '@features/courses/components/course-options-menu/course-options-menu';
import { CoreCourseListItem, CoreCourses, CoreCoursesProvider } from '@features/courses/services/courses';
 ...
 */
@Component({
    selector: 'my-course-list-item',
    templateUrl: 'my-course-list-item.html',
    styleUrls: ['my-course-list-item.scss'],
})
export class MyCourseListItemComponent implements OnInit, OnDestroy, OnChanges {
    ...
    constructor(element: ElementRef, private nav: NavController) {
    ...
    openCourse(): void {
        if (this.isEnrolled) {
            ...
            this.nav.navigateForward(['main/home/event'],navigationExtras);
        } else {
            console.log("hello 2");
        }
    }
