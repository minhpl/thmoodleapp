...
export class AddonModTHPagePrefetchHandlerService extends CoreCourseResourcePrefetchHandlerBase {
    ...
    async downloadOrPrefetch(module: CoreCourseModuleData, courseId: number, prefetch?: boolean): Promise<void> {
        ...
        promises.push(AddonModTHPage.getTHPageData(courseId, module.id));
    ...
    async invalidateContent(moduleId: number, courseId: number): Promise<void> {
        await AddonModTHPage.invalidateContent(moduleId, courseId);
    }
...
export const AddonModTHPagePrefetchHandler = makeSingleton(AddonModTHPagePrefetchHandlerService);
