...
export class AddonModTHPagePluginFileHandlerService implements CorePluginFileHandler {

    name = 'AddonModTHPagePluginFileHandler';
    component = 'mod_thpage';
    ...
    getComponentRevisionRegExp(args: string[]): RegExp | undefined {
        ...
        if (args[2] == 'content') {
            ...
            return new RegExp('/mod_thpage/content/([0-9]+)/');
        }
    }
...
export const AddonModTHPagePluginFileHandler = makeSingleton(AddonModTHPagePluginFileHandlerService);
