...
/**
 * Content links handler for thglossary new entry.
 * Match mod/thglossary/edit.php?cmid=6 with a valid data.
            ...
            action: async (siteId: string) => {
                ...
                try {
                    ...
                    await CoreNavigator.navigateToSitePath(
                        AddonModThGlossaryModuleHandlerService.PAGE_NAME + `/${module.course}/${module.id}/entry/new`,
                        { siteId },
                    );
                } catch (error) {
