...
import { AddonModUrlProvider } from './services/thurl';
import { AddonModUrlHelperProvider } from './services/thurl-helper';
...
const routes: Routes = [
    {
        ...
        loadChildren: () => import('./thurl-lazy.module').then(m => m.AddonModUrlLazyModule),
    },
];
