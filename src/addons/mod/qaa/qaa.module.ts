...
import { AddonModQaaProvider } from './services/qaa';
import { AddonModPageHelperProvider } from './services/qaa-helper';
...
const routes: Routes = [
    {
        ...
        loadChildren: () => import('./qaa-lazy.module').then(m => m.AddonModQaaLazyModule),
    },
];
...
export class AddonModQaaModule {}
