 ...
 */
@Component({
    selector: 'addon-mod-thrdassign-submission-comments',
    templateUrl: 'addon-mod-thrdassign-submission-comments.html',
})
export class AddonModThrdAssignSubmissionCommentsComponent extends AddonModThrdAssignSubmissionPluginBaseComponent {
